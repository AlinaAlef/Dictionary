...
public class PunctuationMark extends Symbol implements SentenceObject {
	...
	/**
	 * Creates a com.epam.lab2.sentenceobjects.PunctuationMark object by the given character symbol.
	...
	private PunctuationMark(char symbol) {
 	...
 	/**
 	 * Creates a com.epam.lab2.sentenceobjects.PunctuationMark object in case the input symbol is really
 	 * a punctuation mark.
